                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <form class="form-horizontal"
                                action="<?= base_url('admin/save_editkategori/'. $kategori['id_kategori']) ?>"
                                method="POST">
                                <?= csrf_field(); ?>


                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="name">Nama Kategori
                                        :</label>
                                    <div class="col-sm-12">
                                        <input type="text"
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <a onclick="return confirm('Tidak jadi mengedit kategori ini ?')"
                                            href="/admin/data_kategori" class="btn btn-warning">Kembali</a>
                                        <button
                                            onclick="return confirm('Apakah anda yakin ingin mengedit kategori ini?')"
