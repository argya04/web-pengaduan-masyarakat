                ...
                <div class="container">
                    <div class="main-body">
                        ...
                        <nav aria-label="breadcrumb" class="main-breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/admin/list_user">List User</a></li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex flex-column align-items-center text-center">
                                            <img src="<?= base_url('/img/profile/profile.svg');?>"
                                                alt="<?= $user->username; ?>" class="rounded-circle" width="150">
                                            <div class="mt-4">
                                                <h4><?= $user->nama; ?></h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                ...
                                                elseif( $user->name=='Admin') echo '<span class="badge badge-danger"
                                                    ...
                                                    style="background-color:#36b9cc">Petugas Kategorial</span>'
                                                ;
                                                ?>
                                            </div>
                                        </div>
