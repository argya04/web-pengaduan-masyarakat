...
<head>
    ...
    <title>Data Kategori Pengaduan</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-3 text-gray-800">Data Kategori Pengaduan</h1>
                ...
                if(session()->getFlashdata('status')) :?>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-outline-primary" href="/admin/tambah_kategori">Tambah
                                <i class="fas fa-plus"></i></a><br><br>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Yakin Mau Menghapus Data Ini?')"
                                                    href=<?= base_url('admin/delete_kategori/' . $row->id_kategori); ?>
