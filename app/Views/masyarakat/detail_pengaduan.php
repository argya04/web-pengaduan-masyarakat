...
<body id="page-top">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="username">NIK :</label>
                                    <div class="col-sm-10">
                                        <label class="control-label" id="username" disabled><?= user()->nik; ?></label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="control-label" id="no_telp"
    ...
    elseif( $lp ['status']=='ditolak') echo '<span class="badge badge-danger" style="background-color:red">Ditolak</span>' ;?>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3  text-info" for="isi_tanggapan">Tanggapan
                                        :</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3 text-info" for="tgl_tanggapan">Tanggal
                                        Tanggapan
                                        :</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <a href=<?= base_url('masyarakat/edit_pengaduan/' . $lp['id_pengaduan']); ?>
                                            class="btn btn-primary btn-sm " aria-disabled="true">Edit Pengaduan <i
                                                class="fas fa-edit"></i></a>
                                        <?php endif;?>

                                        <?php if ($lp['status']=='belum verifikasi'):?>
                                        <a href=<?= base_url('masyarakat/delete_pengaduan/' . $lp['id_pengaduan']); ?>
                                            onclick="return confirm('Apakah anda yakin ingin membatalkan dan menghapus pengaduan ?')"
                                            class="btn btn-danger btn-sm " aria-disabled="true">Delete Pengaduan <i
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <small><a
                                                href="<?= base_url('/masyarakat/statusbelum/belum verifikasi') ?>">&laquo;
                                                Kembali
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <small><a
                                                href="<?= base_url('/masyarakat/statusverifikasi/verifikasi') ?>">&laquo;
                                                Kembali
                                                ke menu sebelumnya</a></small>
                                    </li>
                                </ul>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <small><a href="<?= base_url('/masyarakat/statusproses/proses') ?>">&laquo;
                                                Kembali
                                                ke menu sebelumnya</a></small>
                                    </li>
                                </ul>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <small><a href="<?= base_url('/masyarakat/statusselesai/selesai') ?>">&laquo;
                                                Kembali
                                                ke menu sebelumnya</a></small>
                                    </li>
                                </ul>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <small><a href="<?= base_url('/masyarakat/statustolak/ditolak') ?>">&laquo;
                                                Kembali
                                                ke menu sebelumnya</a></small>
                                    </li>
                                </ul>
