        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h4 class="h4 mb-4 text-gray-800">Form Laporan Pengaduan</h4>
                    <div class="card-body">

                        <form class="form-horizontal" action="<?=base_url('masyarakat/inputPengaduan')?>" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <textarea
                                        ...
                                        name="isi_laporan" rows="3"><?= old('isi_laporan');?></textarea>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-4" for="kategori">Kategori Pengaduan</label>
                                <div class="col-sm-12">
                                    <select
                            ...
                            <input type="hidden" class="form-control" id="no_telepon" name="no_telepon"
                                value="<?=user()->no_telepon; ?>" disabled>



                            <div class="form-group">
                                <label class="control-label col-sm-4" for="foto">Upload Foto Sebagai Bukti Pendukung
                                    :</label>
                                <div class="col-sm-11">
                                    <input type="file"
                                        class="form-group <?= ($validation->hasError('foto')) ? 'is-invalid' : ''; ?>"
                                        name="foto" accept="image/*" value=""><?= old('foto'); ?>
