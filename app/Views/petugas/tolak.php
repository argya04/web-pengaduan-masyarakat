        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Tolak Pengaduan</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <form class="form-horizontal"
                                action="<?= base_url('petugas/savetolak/'. $lp['id_pengaduan']) ?>" method="POST">
                                <?= csrf_field(); ?>

                                <?php $validation = \Config\Services::validation(); ?>

                                <div class="form-group">
                                    <label class="control-label col-sm-4" for="alasan">Beri Alasan Penolakan
                                        Pengaduan
                                        :</label>
                                    <div class="col-sm-12">
                                        <input type="text"
                                            class="form-control <?= ($validation->hasError('alasan')) ? 'is-invalid' : ''; ?>"
                                            id="alasan" name="alasan" value=""
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button onclick="return confirm('Anda yakin ingin menolak pengaduan ini?')"
                                            type="
                                            submit" name="submit" class="btn btn-primary">Submit</button>
                                    </div>
                                </div>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <small><a
                                                href="<?= base_url('/petugas/detail_pengaduan/'. $lp['id_pengaduan']) ?>">&laquo;
                                                Kembali
