...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center active" href="/kategorial/index">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/kategorial/sudahverifikasi">Pengaduan Masuk</a>
                        <a class="collapse-item" href="/kategorial/sudahproses">Pengaduan Diproses</a>
                        <a class="collapse-item" href="/kategorial/sudahselesai">Pengaduan Selesai</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="/kategorial/myprofile">
    ...
    elseif( $lp ['status']=='selesai') echo '<span class="badge badge-success" style="background-color:green">Selesai</span>' ; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <?php if ($lp['status']=='verifikasi'):?>
                                        <a onclick="return confirm('Apakah anda yakin ingin memproses pengaduan ?')"
                                            href=<?= base_url('kategorial/proses/' . $lp['id_pengaduan']); ?>
                                            class="btn btn-primarys <?= ($lp['status'] == 'selesai') | ($lp['status'] == 'ditanggapi') | ($lp['status'] == 'proses') | ($lp['status'] == 'ditolak')  ? 'hidden' : ''; ?>"
                                            aria-disabled="true">Proses <i class="far fa-edit"></i></a><br><br>


                                        <?php endif;?>

                                        <?php if ($lp['status']=='proses'):?>
                                        <a href=<?= base_url('kategorial/tanggapi/' . $lp['id_pengaduan']); ?>
                                            class="btn btn-info btn-sm <?= ($lp['status'] == 'selesai') | ($lp['status'] == 'ditolak') | ($lp['status'] == 'ditanggapi') | ($lp['status'] == 'proses') | ($lp['status'] == 'hidden') ? 'hidden' : ''; ?>"
                                            aria-disabled="true">Tanggapi <i class="far fa-edit"></i></a><br><br>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <a href="/kategorial/sudahverifikasi" class="btn btn-warning">Kembali</a>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <a href="/kategorial/sudahproses" class="btn btn-warning">Kembali</a>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <a href="/kategorial/sudahselesai" class="btn btn-warning">Kembali</a>
